...
FUNDA_AUTOREPLY_TIMEOUT_SECONDS = int(os.getenv("FUNDA_AUTOREPLY_TIMEOUT_SECONDS", "45"))
FUNDA_AUTOREPLY_MAX_PER_SCAN = int(os.getenv("FUNDA_AUTOREPLY_MAX_PER_SCAN", "2"))
FUNDA_AUTOREPLY_MAX_ATTEMPTS_PER_LISTING = int(os.getenv("FUNDA_AUTOREPLY_MAX_ATTEMPTS_PER_LISTING", "3"))
FUNDA_AUTOREPLY_RETRY_COOLDOWN_SECONDS = int(os.getenv("FUNDA_AUTOREPLY_RETRY_COOLDOWN_SECONDS", "3600"))
FUNDA_AUTOREPLY_MANUAL_APPROVAL = _parse_bool(os.getenv("FUNDA_AUTOREPLY_MANUAL_APPROVAL", "false"))
FUNDA_AUTOREPLY_HEADLESS = _parse_bool(os.getenv("FUNDA_AUTOREPLY_HEADLESS", "true"))
FUNDA_AUTOREPLY_DRY_RUN = _parse_bool(os.getenv("FUNDA_AUTOREPLY_DRY_RUN", "false"))
FUNDA_AUTOREPLY_EMAIL = os.getenv("FUNDA_AUTOREPLY_EMAIL", "")
FUNDA_AUTOREPLY_FIRST_NAME = os.getenv("FUNDA_AUTOREPLY_FIRST_NAME", "")
FUNDA_AUTOREPLY_LAST_NAME = os.getenv("FUNDA_AUTOREPLY_LAST_NAME", "")
FUNDA_AUTOREPLY_PHONE = os.getenv("FUNDA_AUTOREPLY_PHONE", "")
FUNDA_AUTOREPLY_DEFAULT_TEMPLATE = os.getenv(
    "FUNDA_AUTOREPLY_DEFAULT_TEMPLATE",
    (
        "Hello, I am interested in this rental listing and would like to schedule a viewing. "
        "Kind regards"
    ),
)
